		...
		public static function register( $wp_customize ) {
			...
			$wp_customize->selective_refresh->add_partial(
				...
				array(
					...
					'render_callback' => 'theme_customize_partial_site_logo',
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'priority'    => 10,
					'label'       => __( 'Retina logo', 'theme' ),
					'description' => __( 'Scales the logo to half its uploaded size, making it sharp on high-res screens.', 'theme' ),
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'header_footer_background_color',
					array(
						'label'   => __( 'Header &amp; Footer Background Color', 'theme' ),
						'section' => 'colors',
					)
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'choices' => array(
						'default' => _x( 'Default', 'color', 'theme' ),
						'custom'  => _x( 'Custom', 'color', 'theme' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'section'         => 'colors',
						'settings'        => 'accent_hue',
						'description'     => __( 'Apply a custom color for links, buttons, featured images.', 'theme' ),
						'mode'            => 'hue',
			...
			$wp_customize->add_control(
				...
				array(
					...
					'section'  => 'options',
					'priority' => 10,
					'label'    => __( 'Show search in header', 'theme' ),
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'section'  => 'options',
					'priority' => 10,
					'label'    => __( 'Show author bio', 'theme' ),
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'section'  => 'options',
					'priority' => 10,
					'label'    => __( 'On archive pages, posts show:', 'theme' ),
					'choices'  => array(
						'full'    => __( 'Full text', 'theme' ),
						'summary' => __( 'Summary', 'theme' ),
					),
				)
			);
			...
			$wp_customize->add_section(
				...
				array(
					'title'       => __( 'Cover Template', 'theme' ),
					'capability'  => 'edit_theme_options',
					'description' => __( 'Settings for the "Cover Template" page template. Add a featured image to use as background.', 'theme' ),
					'priority'    => 42,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'       => __( 'Fixed Background Image', 'theme' ),
					'description' => __( 'Creates a parallax effect when the visitor scrolls.', 'theme' ),
				)
			);
			...
			$wp_customize->add_setting(
				...
				array(
					'default'           => theme_get_color_for_area( 'content', 'accent' ),
					'sanitize_callback' => 'sanitize_hex_color',
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'cover_template_overlay_background_color',
					array(
						'label'       => __( 'Overlay Background Color', 'theme' ),
						'description' => __( 'The color used for the overlay. Defaults to the accent color.', 'theme' ),
						'section'     => 'cover_template_options',
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'cover_template_overlay_text_color',
					array(
						'label'       => __( 'Overlay Text Color', 'theme' ),
						'description' => __( 'The color used for the text in the overlay.', 'theme' ),
						'section'     => 'cover_template_options',
					)
				)
			);
			...
			$wp_customize->add_control(
				'cover_template_overlay_opacity',
				array(
					'label'       => __( 'Overlay Opacity', 'theme' ),
					'description' => __( 'Make sure that the contrast is high enough so that the text is readable.', 'theme' ),
					'section'     => 'cover_template_options',
					'type'        => 'range',
					'input_attrs' => theme_customize_opacity_range(),
				)
			);
 ...
 * */
if ( ! function_exists( 'theme_customize_partial_blogname' ) ) {
	/**
...
if ( ! function_exists( 'theme_customize_partial_blogdescription' ) ) {
	/**
...
if ( ! function_exists( 'theme_customize_partial_site_logo' ) ) {
	/**
	 ...
	 * @since theme 1.0
	 */
	function theme_customize_partial_site_logo() {
		theme_site_logo();
	}
}
 ...
 */
function theme_customize_opacity_range() {
	/**
