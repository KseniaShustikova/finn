				...
				<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
					<footer class="comment-meta">
						...
						<div class="comment-metadata">
							...
							$comment_timestamp = sprintf( __( '%1$s at %2$s', 'theme' ), get_comment_date( '', $comment ), get_comment_time() );
					...
					$by_post_author = theme_is_comment_by_post_author( $comment );
					...
					if ( $comment_reply_link || $by_post_author ) {
						...
						<footer class="comment-footer-meta">
							...
							if ( $by_post_author ) {
								echo '<span class="by-post-author">' . __( 'By Post Author', 'theme' ) . '</span>';
							}
							?>
