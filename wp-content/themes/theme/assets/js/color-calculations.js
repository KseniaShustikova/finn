 ...
 * @return {Object} - this
 */
function _themeColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_themeColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_themeColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_themeColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _themeColor object.
 *
 * @since theme 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function themeColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _themeColor( backgroundColor, accentHue );
